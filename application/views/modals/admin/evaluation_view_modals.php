        ...
        <div class="modal-dialog modal-dialog-scrollable modal-lg" role="document">
          <div class="modal-content">
            ...
            <div class="modal-footer">
              ...
              <!-- <input id="btnAddProjectDetails" type="submit" value="update" class="btn btn-success"> -->
            </div>
            </form>
          </div>
        </div>
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="editsubProjectEvaluationForm" name="editsubProjectEvaluationForm">
                    ...
                    <div class="modal-footer">
                        <input id="btnUpdateProjectEvaluation" type="submit" value="submit" class="btn btn-info">
                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                    </div>
                </form>
            </div>
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="editProjectEvaluationForm" name="editProjectEvaluationForm">
                    ...
                    <div class="modal-footer">
                        <input id="btnUpdateProjectEvaluation" type="submit" value="submit" class="btn btn-success">
                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                    </div>
                </form>
            </div>
